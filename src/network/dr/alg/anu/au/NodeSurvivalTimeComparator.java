...
public class NodeSurvivalTimeComparator<V> implements Comparator<V> {
	 ...
	 */
	public NodeSurvivalTimeComparator(boolean a) {
	...
	public int compare(V v1, V v2) {
		...
		try {
			uploadTime1 = (Double) v1.getClass().getMethod("getSurvivalTime")
					.invoke(v1, null);
			uploadTime2 = (Double) v2.getClass().getMethod("getSurvivalTime")
					.invoke(v2, null);
