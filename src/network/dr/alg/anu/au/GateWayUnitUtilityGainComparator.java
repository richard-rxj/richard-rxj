...
public class GateWayUnitUtilityGainComparator<V> implements Comparator<V> {
	 ...
	 */
	public GateWayUnitUtilityGainComparator(boolean a) {
	...
	public static void main(String[] args) {
		...
		GateWayUnitUtilityGainComparator gLCom=new GateWayUnitUtilityGainComparator(false);
