...
public class TauP_Create {
	...
	public void printUsage() {
		...
		System.out
				.println("Usage: " + className.toLowerCase() + " [arguments]");
		...
		System.out
				.println("-nd modelfile       -- \"named discontinuities\" velocity file");
		System.out
				.println("-tvel modelfile     -- \".tvel\" velocity file, ala ttimes\n");
		System.out
	...
	public static void main(String[] args) throws SlownessModelException,
		...
		if (noComprendoArgs.length > 0) {
			...
			System.out
					.println("I don't understand the following arguments, continuing:");
			for (int i = 0; i < noComprendoArgs.length; i++) {
	...
	public void start() throws SlownessModelException, TauModelException {
		try {
			...
			sMod.setMaxDepthInterval(Double.valueOf(
					toolProps.getProperty("taup.create.maxDepthInterval",
							"115.0")).doubleValue());
			sMod.setMaxRangeInterval(Double.valueOf(
					toolProps.getProperty("taup.create.maxRangeInterval",
							"1.75")).doubleValue());
			sMod.setMaxInterpError(Double
					.valueOf(
							toolProps.getProperty("taup.create.maxInterpError",
									"0.05")).doubleValue());
			sMod.setAllowInnerCoreS(Boolean
					.valueOf(
							toolProps.getProperty(
