...
public class GateWayPriorityWeightComparator<V> implements Comparator<V> {
	 ...
	 */
	public GateWayPriorityWeightComparator(boolean a) {
	...
	public int compare(V v1, V v2) {
		...
		try {
			lBenefit1 = (Double) v1.getClass().getMethod("getPriorityWeight")
					.invoke(v1, null);
			lBenefit2 = (Double) v2.getClass().getMethod("getPriorityWeight")
					.invoke(v2, null);
	...
	public static void main(String[] args) {
		...
		GateWayPriorityWeightComparator gLCom=new GateWayPriorityWeightComparator(false);
