...
public class SphericalCoords {
	...
	public static double azimuth(double latA, double lonA, double latB,
			double lonB) {
	 ...
	 *          pole.
	 */
	public static double[] rotationPole(double latA, double lonA, double latB,
			double lonB) {
	 ...
	 */
	public static double[] rotate(double latA, double lonA, double[] pole,
			double angleDeg) {
	 ...
	 */
	public static double latFor(double latA, double lonA, double distance,
			double azimuth) {
		return rtod
	 ...
	 */
	public static double lonFor(double latA, double lonA, double distance,
			double azimuth) {
	...
	public static void main(String args[]) {
		...
		System.out.println(latFor(35, 42, distance(35, 42, 36, 43), azimuth(35,
				42, 36, 43))
				+ "   "
				+ lonFor(35, 42, distance(35, 42, 36, 43), azimuth(35, 42, 36,
						43)));
	}
}
