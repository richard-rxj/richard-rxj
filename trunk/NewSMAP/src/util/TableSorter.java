...
// TableRowSorter only appears in the Java library since version 1.6. 
// This class is provided here as a replacement of that class 
// so that the program is compatible 
// with JDK version 1.5 and earlier.
...
public class TableSorter extends AbstractTableModel {
	...
	public static final Comparator<Object> COMPARABLE_COMPARATOR = new Comparator<Object>() {
		public int compare(Object o1, Object o2) {
			...
			if(!java.lang.Comparable.class.isInstance(o1) 
				|| !java.lang.Comparable.class.isInstance(o2)) {
				throw new ClassCastException();
			}
			
			
			// Modified by Cong Phuoc Huynh on 24 Sept 2010 to check for 
			// object class compatibility.
			// Check if o2 is an instance of the class of o1
...
//				
//				// Modified by Cong Phuoc Huynh on 24 Sept 2010 to cover the case
//				// where the class of o1 does not have a compareTo method. 
//				// Rather it inherits this method from a parent class.
//				m = o1.getClass().getMethod("compareTo", o1.getClass());
...
//			}
			...
			Object retVal = ((Comparable)o1).compareTo(o2);
