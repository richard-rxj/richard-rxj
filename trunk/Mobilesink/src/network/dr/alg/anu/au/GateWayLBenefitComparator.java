...
public class GateWayLBenefitComparator<V> implements Comparator<V> {
	 ...
	 */
	public GateWayLBenefitComparator(boolean a) {
	...
	public static void main(String[] args) {
		...
		GateWayLBenefitComparator gLCom=new GateWayLBenefitComparator(false);
