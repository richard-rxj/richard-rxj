...
public class GateWayUtilityGainComparator<V> implements Comparator<V> {
	 ...
	 */
	public GateWayUtilityGainComparator(boolean a) {
	...
	public static void main(String[] args) {
		...
		GateWayUtilityGainComparator gLCom=new GateWayUtilityGainComparator(false);
