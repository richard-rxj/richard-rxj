...
public class SDC extends JFrame {
	...
	public SDC() {
		...
		super("ANU-RSES Seismic Data Centre v1.7");
		 ...
		 */
		theMainPanel.setDividerLocation(0.62);
	}
	...
	public void displayCharts() {
		...
		chartPanel.setBackground(SDC.background);
		...
		for (String component : curComponents) {
			...
			if (loadFileList.isEmpty()) {
				JOptionPane.showMessageDialog(SDC.this,
...
//---------------begin of v1.7-------------------------------------------------------------
				ef.setSize(SDC.this.getWidth()/5, SDC.this.getHeight()/5);
				ef.setLocation(SDC.this.getLocation().x + (SDC.this.getWidth() - ef.getWidth())/2, 
						SDC.this.getLocation().y + (SDC.this.getHeight() - ef.getHeight())/2);
//---------------end of v1.7-------------------------------------------------------------	
