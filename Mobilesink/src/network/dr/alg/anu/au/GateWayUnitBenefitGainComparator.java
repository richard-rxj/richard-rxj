...
public class GateWayUnitBenefitGainComparator<V> implements Comparator<V> {
	 ...
	 */
	public GateWayUnitBenefitGainComparator(boolean a) {
	...
	public int compare(V v1, V v2) {
		...
		try {
			lBenefit1 = (Double) v1.getClass().getMethod("getUnitBenefitGain")
					.invoke(v1, null);
			lBenefit2 = (Double) v2.getClass().getMethod("getUnitBenefitGain")
					.invoke(v2, null);
	...
	public static void main(String[] args) {
		...
		GateWayUnitBenefitGainComparator gLCom=new GateWayUnitBenefitGainComparator(false);
